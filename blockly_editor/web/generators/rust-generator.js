/**
 * Consolidated Rust Code Generator for Biospheres Blockly System
 * 
...
RustGenerator.forBlock['rust_call'] = function(block) {
    ...
    return [`${func}(${args})`, RustGenerator.ORDER_ATOMIC];
};
...
RustGenerator.forBlock['rust_reference_node'] = function(block) {
    ...
    if (targetMode === 'wgsl') {
        ...
        code += '\n';
    } else if (targetMode === 'rust' || targetMode === 'bevy' || targetMode === 'biospheres') {
        // Rust/Bevy/Biospheres reference - generate use statement
        if (targetSymbol) {
...
// ============================================================================
// ADDITIONAL BEVY SYSTEM PARAMETERS
// ============================================================================
