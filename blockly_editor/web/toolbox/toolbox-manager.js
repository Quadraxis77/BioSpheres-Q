...
class ToolboxManager {
     ...
     * @param {string} mode - The mode to load ('rust', 'wgsl', 'bevy', 'biospheres')
    ...
    async loadToolbox(mode) {
        ...
        try {
            ...
            console.log('[Toolbox Manager] BiospheresToolbox available:', typeof BiospheresToolbox !== 'undefined');
            ...
            switch (mode) {
                ...
                case 'biospheres':
                    if (typeof BiospheresToolbox !== 'undefined') {
                        console.log('[Toolbox Manager] Loading Biospheres toolbox...');
                        toolboxConfig = BiospheresToolbox.getToolbox();
                        console.log('[Toolbox Manager] Biospheres toolbox loaded, categories:', toolboxConfig?.contents?.length);
                    }
                    break;
