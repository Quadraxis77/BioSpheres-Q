 ...
 * Mode Manager Module
 * 
 * Manages editor mode switching between Rust, WGSL, Bevy, and Biospheres modes.
...
const MODES = {
    ...
    biospheres: {
        ...
        fileExtension: 'rs',
        mimeType: 'text/x-rust',
        toolbox: 'biospheres-toolbox',
        defaultFile: 'cells.rs',
        description: 'Biospheres cell biology simulation',
        theme: {
        ...
        validator: 'rust'  // Biospheres uses Rust syntax
    }
};
...
class ModeManager {
     ...
     * @param {string} mode - The target mode ('rust', 'wgsl', 'bevy', 'biospheres')
    ...
    _updateUITheme(theme) {
        ...
        document.body.classList.remove('mode-rust', 'mode-wgsl', 'mode-bevy', 'mode-biospheres');
