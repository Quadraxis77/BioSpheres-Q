// Blockly Bridge - Integration between Blockly editor and Biospheres
...
/// Convert Blockly genome to Biospheres internal format
impl BlocklyGenome {
    pub fn to_biospheres_genome(&self) -> crate::genome::Genome {
        // Convert Blockly format to internal Biospheres genome format
